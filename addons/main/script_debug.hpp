...
// To Use: [] call vetufl_PREP_RECOMPILE;
    ...
    #define PREP_RECOMPILE_ADD_BUTTON \
        if (isNil 'PREFIX##_PREP_RECOMPILE_BUTTON') then {\
            [] spawn {\
                ...
                [['Recomp. PREFIX', 'Recompile functions of PREFIX'], {call PREFIX##_PREP_RECOMPILE}] call (uiNamespace getVariable ['afm_debug_console_fnc_addButton', {}]);\
            };\
